...
const (
	...
	DBHelper_PatchWithoutParam_FullMethodName           = "/proto.DBHelper/PatchWithoutParam"
...
type DBHelperClient interface {
	...
	Post(ctx context.Context, in *PostRequest, opts ...grpc.CallOption) (*Response, error)
	Put(ctx context.Context, in *PutRequest, opts ...grpc.CallOption) (*Response, error)
	PatchWithoutParam(ctx context.Context, in *PatchWithoutParamRequest, opts ...grpc.CallOption) (*Response, error)
	Patch(ctx context.Context, in *PatchRequest, opts ...grpc.CallOption) (*Response, error)
...
func (c *dBHelperClient) PatchWithoutParam(ctx context.Context, in *PatchWithoutParamRequest, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, DBHelper_PatchWithoutParam_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DBHelperServer interface {
	...
	Post(context.Context, *PostRequest) (*Response, error)
	Put(context.Context, *PutRequest) (*Response, error)
	PatchWithoutParam(context.Context, *PatchWithoutParamRequest) (*Response, error)
	Patch(context.Context, *PatchRequest) (*Response, error)
...
func (UnimplementedDBHelperServer) PatchWithoutParam(context.Context, *PatchWithoutParamRequest) (*Response, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PatchWithoutParam not implemented")
}
...
func _DBHelper_PatchWithoutParam_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PatchWithoutParamRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DBHelperServer).PatchWithoutParam(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DBHelper_PatchWithoutParam_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DBHelperServer).PatchWithoutParam(ctx, req.(*PatchWithoutParamRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var DBHelper_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "PatchWithoutParam",
			Handler:    _DBHelper_PatchWithoutParam_Handler,
		},
		{
			MethodName: "Patch",
